...
test.describe('Story 4.1: Snapshot (Local Backup)', () => {
  ...
  test('should create a snapshot with a label from toolbar button', async ({ page }) => {
  ...
  test('should create a snapshot without a label', async ({ page }) => {
    // TODO: Navigate to open novel
  ...
  test('should list snapshots in diagnostics panel', async ({ page }) => {
  ...
  test('should restore a snapshot from list', async ({ page }) => {
  ...
  test('should delete a snapshot from list', async ({ page }) => {
    // TODO: Create a snapshot
    // TODO: Open diagnostics panel > snapshots
  ...
  test('should show error when snapshot fails due to disk space', async ({ page }) => {
  ...
  test('should include all directories (manuscript, wiki, meta) in snapshot', async ({ page }) => {
  ...
  test('should create unique snapshot directories for rapid snapshots', async ({ page }) => {
